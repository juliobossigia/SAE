...
<form action="{{ route('registros.store') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" id="encaminhado_para" name="encaminhado_para" value="{{ old('encaminhado_para') }}" required>
    </div>
    <div class="form-group registro">
        <label for="agendamento">Realizar Agendamento:</label>
        <div class="radio-group">
            <input type="radio" name="agendamento" id="agendamento_sim" value="1" {{ old('agendamento') == '1' ? 'checked' : '' }}>
            <label for="agendamento_sim">Sim</label>

            <input type="radio" name="agendamento" id="agendamento_nao" value="0" {{ old('agendamento') == '0' ? 'checked' : '' }}>
