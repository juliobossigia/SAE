        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('docente.agendamentos.index') }}" 
                   class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-md hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Encaminhado Para</th>
                                ...
                                @foreach($registros as $registro)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-900">
                                            {{ Str::limit($registro->descricao, 50) }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-center space-x-2">
                                                <a href="{{ route('docente.registros.show', $registro->id) }}" 
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Comece criando um novo registro.</p>
                        <div class="mt-6">
                            <a href="{{ route('docente.registros.create') }}" 
